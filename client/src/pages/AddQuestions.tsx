...
const AddQuestions: React.FC = () => {
  ...
  const handleCreateTest = async () => {
    ...
    if( questions.codingQuestions.length < test.numCodingQues || questions.mcqs.length < test.numMcqs ){  
  ...
  return (
    <div className="w-full h-full relative p-8 pt-10 flex flex-col gap-4">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-row gap-16">
          <h1 className='font-semibold min-w-56'>Number of Coding questions: </h1>
          <p className="px-4 py-1 w-[200px]  border border-gray-300 rounded-sm">
            {test.numCodingQues}
          </p>
        </div>
      ...
      <div>
        ...
        {mcqs.length < test.numMcqs && (
          <button
            ...
            className="bg-black text-yellow-400 px-4 py-1 "
          >
            Add Question
          </button>
        )}
      ...
      <button
        ...
        className="w-1/4 px-4 py-2 bg-black  text-yellow-400 rounded-md active:text-black active:bg-white border border-black/40"
      >
        Create Test
      </button>
    </div>
