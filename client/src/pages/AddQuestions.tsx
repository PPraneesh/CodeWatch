...
const AddQuestions: React.FC = () => {
  ...
  return (
    <div className='w-full h-full p-8 pt-10 flex flex-col gap-4' >
      <div className='flex flex-col gap-4'>
        <h1 className='text-4xl font-semibo'>Add Questions</h1>
        <div className="flex flex-row gap-16 justify-start items-center">
          <h1>Test Name: </h1>
          <p className='px-1 py-1 w-[200px]  border border-gray-300 rounded-sm'>{test.testName}</p>
        </div>
        <div className="flex flex-row gap-16">
          <h1>Duration: </h1>
          <p className='px-1 py-1 w-[200px]  border border-gray-300 rounded-sm'>{test.duration}</p>
        </div>
        <div className="flex flex-row gap-16">
          <h1>Time: </h1>
          <p className='px-1 py-1 w-[200px]  border border-gray-300 rounded-sm'>{test.examTime}</p>
        </div>
        <div className="flex flex-row gap-16">
          <h1>Language: </h1>
          <p className='px-1 py-1 w-[200px]  border border-gray-300 rounded-sm'>{test.language}</p>
        </div>
        <div className="flex flex-row gap-16">
          <h1>Number of Coding questions: </h1>
          <p className='px-1 py-1 w-[200px]  border border-gray-300 rounded-sm'>{test.numCodingQues}</p>
        </div>
        <div className="flex flex-row gap-16">
          <h1>Number of MCQs: </h1>
          <p className='px-1 py-1 min-w-[200px]  border border-gray-300 rounded-sm'>{test.numMcqs}</p>
        </div>
        <div className="flex flex-row gap-16">
          <h1>Teacher: </h1>
          <p className='px-1 py-1 w-[200px]  border border-gray-300 rounded-sm'>{test.email?.split('@')[0]}</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className='w-full flex flex-col items-center gap-4 '>
          {codingQuestions.map((question: any, index: number) => {
            return (
              <div key={index} className='w-full p-4 bg-blue-200 border border-black/20 '>
        ...
        <button onClick={handleAddCoding} className='bg-blue-700 text-white px-4 mt-4 mb-4 py-1 '>Add Question</button>
      </div>
      ...
      <div>
        ...
        <button onClick={handleAddMcq} className='bg-blue-700 text-white px-4 py-1 '>Add Question</button>
      </div>
      ...
      <button onClick={handleCreateTest} className='w-1/4 px-4 py-2 bg-blue-600 text-white rounded-md active:text-black active:bg-white border border-black/40'>Create Test</button>
