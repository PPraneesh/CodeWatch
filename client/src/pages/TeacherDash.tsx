...
const TeacherDash: React.FC = () => {
  ...
  return (
    <div className='h-full w-full p-8 flex flex-col gap-4'>
      ...
      <div>
        <h1 className='font-sans text-xl'>Faculty Metrics</h1>
        <div className='min-h-72 bg-gray-400'>

        </div>
      </div>

      <div>
        <h1 className='font-sans text-xl'>Last Test Metrics</h1>
        <p className='font-thin text-sm'>Performance overview</p>
      ...
      <div className='flex flex-row justify-evenly items-center gap-4'>
        <button className='flex-1 bg-black border text-white py-2 rounded-lg hover:bg-white hover:border-black hover:text-black'>Export Data</button>
        <button className='flex-1 bg-black border text-white py-2 rounded-lg hover:bg-white hover:border-black hover:text-black'>Generate Report</button>
      </div>
